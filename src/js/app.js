...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h2>${variables.role ? variables.role : " Web Develop"}</h2>
          <h3>${variables.city ? variables.city : " Miami Florida"}
          ${variables.country ? variables.country : " Spain"}</h3>
          <ul class="${
